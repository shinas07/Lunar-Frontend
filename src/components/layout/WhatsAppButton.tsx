...
/** Fixed WhatsApp chat button — bottom-right on every page. */
export function WhatsAppButton() {
  return (
    <a
      ...
      data-cursor="hover"
      className="group fixed bottom-5 right-5 z-[120] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_10px_30px_-6px_rgba(37,211,102,0.6)] transition-transform duration-300 hover:scale-110 md:bottom-7 md:right-7"
    >
